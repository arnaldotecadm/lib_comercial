...
/**
 * The persistent class for the pedr12 database table.
 * 
 */
@Entity
@NamedQuery(name = "Pedr12.findAll", query = "SELECT p FROM Pedr12 p")
public class Pedr12 implements Serializable {
