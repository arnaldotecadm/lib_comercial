...
/**
 * The persistent class for the pedr11 database table.
 * 
 */
@Entity
@NamedQuery(name = "Pedr11.findAll", query = "SELECT p FROM Pedr11 p")
public class Pedr11 implements Serializable {
