...
/**
 * The primary key class for the peddpe database table.
 * 
 */
@Embeddable
public class PeddpePK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof PeddpePK)) {
			return false;
		}
		PeddpePK castOther = (PeddpePK)other;
		return 
