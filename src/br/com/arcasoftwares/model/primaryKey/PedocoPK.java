...
/**
 * The primary key class for the pedoco database table.
 * 
 */
@Embeddable
public class PedocoPK implements Serializable {
	...
	public Integer getSeqoco() {
		return this.seqoco;
	}
	public void setSeqoco(Integer seqoco) {
		this.seqoco = seqoco;
	}
	...
	public int hashCode() {
		...
		hash = hash * prime + this.seqoco.hashCode();
