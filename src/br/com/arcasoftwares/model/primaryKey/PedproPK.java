...
/**
 * The primary key class for the pedpro database table.
 * 
 */
@Embeddable
public class PedproPK implements Serializable {
	...
	public Integer getSeqpro() {
		return this.seqpro;
	}
	public void setSeqpro(Integer seqpro) {
		this.seqpro = seqpro;
	}
	...
	public int hashCode() {
		...
		hash = hash * prime + this.seqpro.hashCode();
